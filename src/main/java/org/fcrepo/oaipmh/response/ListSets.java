...
import org.fcrepo.oaipmh.xml.ListSetsElement;
...
public class ListSets extends Response {
    ...
    // private ListSetsElement listSetsElement;
    ...
    public ListSets(MultiValueMap paramMap, String uri) throws JAXBException, OaipmhException {
        super(paramMap, uri);
